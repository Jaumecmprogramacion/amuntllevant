...
<head>
    ...
    <style>
        ...
        #player-modal {
            ...
            z-index: 1000;
            width: 90%;  /* El modal ocupará el 90% del ancho de la pantalla */
            max-width: 900px;  /* Máximo ancho en píxeles */
            height: 90%;  /* El modal ocupará el 90% de la altura de la pantalla */
            max-height: 80%;  /* Máxima altura en píxeles */
            border-radius: 8px;
            overflow-y: auto;  /* Permitirá el desplazamiento vertical si el contenido es demasiado largo */
        ...
        /* En pantallas pequeñas, cada columna ocupa todo el ancho */
        #player-modal .modal-body div {
            flex: 1 1 100%; /* En pantallas pequeñas, ocupará todo el ancho disponible */
            margin-bottom: 20px;
        }
        ...
        /* Para pantallas pequeñas, hacer que los textos largos se ajusten */
        ...
        /* Desplazamiento horizontal de la tabla en pantallas pequeñas */
        @media (max-width: 768px) {
            table {
                overflow-x: auto;
                display: block;
...
<div id="player-modal">
    ...
    <div class="modal-body">
        ...
        <div>
            ...
            <p><strong>Goles encajados estando en el campo:</strong> <span id="modalGE"></span></p>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        ...
        $('#estadisticas').DataTable({
            ...
            info: false        // Desactiva la visualización de información de entradas
        });

        // Mostrar modal con los detalles del jugador
